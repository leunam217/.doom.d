...
(scroll-bar-mode t)
(cua-mode t)
;;(load-file "~/.doom.d/awesome-tab.el")
(load-file "~/.doom.d/tabbar/tabbar.el")
(tabbar-mode t)
;;(require 'pc-bufsw)
(load-file "~/.doom.d/pc-bufsw.el")
(pc-bufsw)
...
(define-key global-map "\C-j" 'my-add-buffer)

(define-key global-map "\C-k" 'my-remove-buffer)

(define-key global-map (kbd "<M-s-right>") 'tabbar-forward)

(define-key global-map (kbd "<M-s-left>") 'tabbar-backward)

(define-key global-map [s-tab] 'my-switch-tab-group)
(tabbar-mode 1)
